...
#'
#' Creates a  \code{factor.grid} dataframe of data-filtering conditions for passing to additional to additional \link{factorial-design functions}.
#'
...
#' @return a data.frame of factorial-based filtering condition or a \code{filter.grid} list for passing to additional \link{factorial-design functions}
